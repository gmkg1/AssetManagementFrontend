import { Component, OnInit, OnDestroy, HostListener, ChangeDetectorRef, Optional } from '@angular/core';
...
@Component({
  selector: 'app-asset-dashboard-dashboard',
  ...
  navigateTo(path: string): void {
    if (this.dashboardTabsService) {
      const routeToTab: Record<string, string> = {
        '/kjusys/asset-management/asset-dashboard': 'dashboard',
        '/kjusys/asset-management/view-assets': 'view-assets',
        '/kjusys/asset-management/create-asset': 'create-asset',
        '/kjusys/asset-management/edit-asset': 'edit-asset',
        '/kjusys/asset-management/issue-asset': 'issue-asset',
        '/kjusys/asset-management/return-asset': 'return-asset',
        '/kjusys/asset-management/issue-log': 'issue-log',
        '/kjusys/asset-management/return-log': 'return-log',
        '/kjusys/asset-management/create-asset-tag': 'create-asset-tag',
        '/kjusys/asset-management/reports': 'reports'
      };
      const tab = routeToTab[path];
      if (tab) {
        this.dashboardTabsService.changeTab(tab);
      } else {
